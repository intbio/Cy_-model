...
<a id="id2"></a>
**4** - Расчеты длины линкера были произведены по упрощенной модели (где линке представлен в виде алкана), из кол-ва связей и длины связи С-С рассчитывалась средняя длина линкера<sup>[7](http://www.chem.msu.su/rus/teaching/lachinov-basic/part012.html)</sup><sup>, </sup><sup>[8](https://www.theorie.physik.uni-muenchen.de/lsfrey/teaching/archiv/sose_06/softmatter/talks/Peter_Jensen-Polymers.pdf)</sup>.\
Формула: 
