...
|Компания|Флюорофоры|Радиус красителя (Å)|Длина линкера(Å)|Медианная длина красителя с линкером (Å)|
| -------|:--------:|:------------------:|:--------------:|--------------------------:|
...
<a id="id3"></a>
**5** - Медианная длина красителя с линкером расчитывалась по коду лежащему по пути: _projects/2020_MD_FRET_modelling_NV/Md_analysis/FRETstein (1).ipynb
